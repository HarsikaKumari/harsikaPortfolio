...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("kumariharsika8@gmail.com");
        setHasCopied(true);
        setTimeout(() => {
            setHasCopied(false);
        }, 2000);
                    ...
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">
                                With 2 years of experience in coding journey, I have honed my skills in frontend and backend development.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">kumariharsika8@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
